...
- [**MDMT**]([https://github.com/fruffini/<REPO>](https://github.com/fruffini/Multi-Dataset-Multi-Task-Learning-for-COVID-19-Prognosis)): Multi-task / multi-modal framework for COVID-19 chest X-ray prognosis (AIforCOVID / BRIXIA). *Presented at MICCAI 2024.* 
...
- [**NSCLC Multimodal Survival**]([https://github.com/fruffini/<REPO>](https://github.com/fruffini/Handling-Missing-Modalities-in-Multimodal-Survival-Prediction-for-Non-Small-Cell-Lung-Cancer)): Intermediate-fusion survival prediction for NSCLC combining tabular (NAIM + ODST) and foundation-model features.
